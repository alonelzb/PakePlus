import{_ as n,c as a,o as l,ag as p}from"./chunks/framework.BgId8OS5.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"k8s/rancher部署.md","filePath":"k8s/rancher部署.md"}'),e={name:"k8s/rancher部署.md"};function o(r,s,c,t,i,b){return l(),a("div",null,s[0]||(s[0]=[p(`<h2 id="主机" tabindex="-1">主机 <a class="header-anchor" href="#主机" aria-label="Permalink to &quot;主机&quot;">​</a></h2><div class="language-bash line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-lighter vp-code" tabindex="0"><code><span class="line"></span>
...
<span class="line"><span style="color:#90A4AE;">      </span></span>
<span class="line"><span style="color:#E2931D;"> cluster_name:</span><span style="color:#91B859;"> mycluster</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div>`,12)]))}const u=n(e,[["render",o]]);export{m as __pageData,u as default};

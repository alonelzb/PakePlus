import{_ as n,c as a,o as l,ag as p}from"./chunks/framework.BgId8OS5.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{"date":"2024-03-09 13:04:43"},"headers":[],"relativePath":"scripts/dns.md","filePath":"scripts/dns.md"}'),e={name:"scripts/dns.md"};function o(c,s,r,t,i,y){return l(),a("div",null,s[0]||(s[0]=[p(`<div class="language-sh line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-lighter vp-code" tabindex="0"><code><span class="line"><span style="color:#90A4AE;">domain</span><span style="color:#39ADB5;">=</span><span style="color:#91B859;">example.com</span></span>

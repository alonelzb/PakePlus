import{_ as n,c as a,o as l,ag as p}from"./chunks/framework.BgId8OS5.js";const B=JSON.parse('{"title":"","description":"","frontmatter":{"date":"2024-03-26 13:04:43"},"headers":[],"relativePath":"scripts/keepalived.md","filePath":"scripts/keepalived.md"}'),e={name:"scripts/keepalived.md"};function r(c,s,o,t,i,b){return l(),a("div",null,s[0]||(s[0]=[p(`<div class="language-sh line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-lighter vp-code" tabindex="0"><code><span class="line"><span style="color:#90A4AE;font-style:italic;">#!/bin/bash</span></span>

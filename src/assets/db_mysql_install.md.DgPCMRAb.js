import{_ as n,c as a,o as l,ag as p}from"./chunks/framework.BgId8OS5.js";const m=JSON.parse('{"title":"安装","description":"","frontmatter":{"title":"安装"},"headers":[],"relativePath":"db/mysql/install.md","filePath":"backend/db/mysql/install.md"}'),e={name:"db/mysql/install.md"};function o(r,s,c,t,i,y){return l(),a("div",null,s[0]||(s[0]=[p(`<h2 id="一-yum-安装" tabindex="-1">一 yum 安装 <a class="header-anchor" href="#一-yum-安装" aria-label="Permalink to &quot;一 yum 安装&quot;">​</a></h2><div class="language-bash line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-lighter vp-code" tabindex="0"><code><span class="line"><span style="color:#E2931D;">yum</span><span style="color:#91B859;"> install</span><span style="color:#91B859;"> -y</span><span style="color:#91B859;"> mysql-server</span></span>

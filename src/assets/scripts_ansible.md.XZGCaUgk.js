import{_ as n,c as a,o as l,ag as p}from"./chunks/framework.BgId8OS5.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{"date":"2024-03-24 12:23:14"},"headers":[],"relativePath":"scripts/ansible.md","filePath":"scripts/ansible.md"}'),e={name:"scripts/ansible.md"};function o(r,s,c,t,i,y){return l(),a("div",null,s[0]||(s[0]=[p(`<h2 id="ssh批量认证" tabindex="-1">ssh批量认证 <a class="header-anchor" href="#ssh批量认证" aria-label="Permalink to &quot;ssh批量认证&quot;">​</a></h2><div class="language-bash line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-lighter vp-code" tabindex="0"><code><span class="line"><span style="color:#90A4AE;font-style:italic;">#!/bin/bash</span></span>
...
<span class="line"><span style="color:#E53935;">        state</span><span style="color:#39ADB5;">:</span><span style="color:#91B859;"> restarted</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div>`,15)]))}const u=n(e,[["render",o]]);export{m as __pageData,u as default};

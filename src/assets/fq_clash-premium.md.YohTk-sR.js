import{_ as n,c as a,o as l,ag as p}from"./chunks/framework.BgId8OS5.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{"date":"2024-04-03 18:28:47"},"headers":[],"relativePath":"fq/clash-premium.md","filePath":"fq/clash-premium.md"}'),e={name:"fq/clash-premium.md"};function o(r,s,c,t,i,y){return l(),a("div",null,s[0]||(s[0]=[p(`<h2 id="dns说明" tabindex="-1">DNS说明 <a class="header-anchor" href="#dns说明" aria-label="Permalink to &quot;DNS说明&quot;">​</a></h2><div class="language-yaml line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki material-theme-lighter vp-code" tabindex="0"><code><span class="line"><span style="color:#E53935;">dns</span><span style="color:#39ADB5;">:</span></span>

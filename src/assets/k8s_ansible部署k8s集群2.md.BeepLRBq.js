import{_ as n,c as a,o as l,ag as p}from"./chunks/framework.BgId8OS5.js";const u=JSON.parse('{"title":"1ssh key 认证和安装python","description":"","frontmatter":{"date":"2024-04-10 16:24:53"},"headers":[],"relativePath":"k8s/ansible部署k8s集群2.md","filePath":"k8s/ansible部署k8s集群2.md"}'),e={name:"k8s/ansible部署k8s集群2.md"};function o(r,s,c,t,i,b){return l(),a("div",null,s[0]||(s[0]=[p(`<h1 id="_1ssh-key-认证和安装python" tabindex="-1">1ssh key 认证和安装python <a class="header-anchor" href="#_1ssh-key-认证和安装python" aria-label="Permalink to &quot;1ssh key 认证和安装python&quot;">​</a></h1><div class="language-bash line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-lighter vp-code" tabindex="0"><code><span class="line"><span style="color:#90A4AE;font-style:italic;">#!/bin/bash</span></span>

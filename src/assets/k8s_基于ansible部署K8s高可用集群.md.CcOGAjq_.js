import{_ as n,c as a,o as l,ag as p}from"./chunks/framework.BgId8OS5.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{"kdate":"2024-03-03 13:42:09"},"headers":[],"relativePath":"k8s/基于ansible部署K8s高可用集群.md","filePath":"k8s/基于ansible部署K8s高可用集群.md"}'),e={name:"k8s/基于ansible部署K8s高可用集群.md"};function o(r,s,c,t,i,b){return l(),a("div",null,s[0]||(s[0]=[p(`<h2 id="kubenetes1-27-11高可用集群的搭建" tabindex="-1">kubenetes1.27.11高可用集群的搭建 <a class="header-anchor" href="#kubenetes1-27-11高可用集群的搭建" aria-label="Permalink to &quot;kubenetes1.27.11高可用集群的搭建&quot;">​</a></h2><h2 id="网络环境" tabindex="-1">网络环境 <a class="header-anchor" href="#网络环境" aria-label="Permalink to &quot;网络环境&quot;">​</a></h2><div class="language-bash line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-lighter vp-code" tabindex="0"><code><span class="line"><span style="color:#E2931D;">节点网络:</span><span style="color:#91B859;"> 10.1.0.0/16</span></span>

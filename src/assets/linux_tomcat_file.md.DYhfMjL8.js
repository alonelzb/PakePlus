import{_ as n,c as a,o as l,ag as e}from"./chunks/framework.BgId8OS5.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"linux/tomcat/file.md","filePath":"linux/tomcat/file.md"}'),p={name:"linux/tomcat/file.md"};function r(c,s,i,o,t,b){return l(),a("div",null,s[0]||(s[0]=[e(`<ul><li>bin 服务启动、停止等相关程序和文件</li><li>conf 配置文件</li><li>lib 库目录</li><li>logs 日志目录</li><li>webapps 应用程序，应用部署目录</li><li>work jsp编译后的结果文件，建议提前预热访问，升级应用后，删除此目录数据才能更新</li></ul><h2 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-label="Permalink to &quot;配置文件&quot;">​</a></h2><p><strong>conf</strong>目录</p><div class="language-bash line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-lighter vp-code" tabindex="0"><code><span class="line"><span style="color:#E2931D;">文件名</span></span>
